          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  <a href="#" id="dLabel" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Anzeigen<span class="caret"></span></a>
                        ...
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                          ...
                          <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu"--> 
                            	...
                            	<!-- MEGA MENU -->
                            	<!--ul class="nav navbar-nav"-->
                            	<li class="dropdown-submenu mega-dropdown" data-toggle="dropdown">
                                <a href="#" tabindex="-1" href="#">Collection</a>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="/TCM/kraut/kraut_eingabe.php">Kraut hinzufügen</a></li>
                    <li><a href="/TCM/formel/formel_eingabe.php">Formel hinzufügen</a></li>
                    <li role="separator" class="divider"></li>
                    <li><a href="#">Krautkategorie hinzufügen</a></li>
                    <li><a href="#">Formelkategorie hinzufügen</a></li>
                    <li role="separator" class="divider"></li>
